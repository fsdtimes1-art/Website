...
export default function BookMeeting() {
  ...
  function handleSubmit() {
    ...
    const lines = [
      'ðŸ‘‹ *New Faisalabad Times Meeting Request*',
      '',
      `*Name:* ${form.name}`,
      `*WhatsApp:* ${form.phone}`,
    ...
    <main className="bm-page">
      ...
      <section className="bm-hero">
        <div className="container">
          ...
          <p>From events to restaurants, retail, brand launches, and digital marketingâ€”tell us what you want to grow. We will reply on WhatsApp with the next practical step.</p>
        </div>
      </section>
          ...
          <div className="bm-service-grid">
            {SERVICES.map(service => (
              <article className="bm-service-card" key={service.number}>
                ...
                <button type="button" className="bm-card-link" onClick={() => { setForm(current => ({ ...current, serviceType: current.serviceType || service.title })); document.getElementById('booking-form')?.scrollIntoView({ behavior: 'smooth', block: 'start' }) }}>Discuss this service <span>â†’</span></button>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="bm-form-section" id="booking-form">
        <div className="container">
          <div className="bm-form-heading">
            ...
            <p>A bigger weekend crowd, a restaurant launch, a smarter content rhythm, or the next event on the calendarâ€”we can shape the right campaign together.</p>
          </div>
            ...
            <div className="bm-form-sticky">
              {submitted ? <SuccessState onReset={() => setSubmitted(false)} /> : <div className="bm-form-card">
                ...
                <div className="bm-form-fields">
                  ...
                  <button type="button" onClick={handleSubmit} disabled={!isValid} className="bm-submit">Send via WhatsApp <span>â†’</span></button>
