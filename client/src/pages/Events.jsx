...
const pulsePassEventsCss = `
  ...
  .pp-events-hero { position:relative; overflow:hidden; padding:104px 0 32px; }.pp-events-hero::after { position:absolute; inset:0; content:''; opacity:.28; background-image:radial-gradient(rgba(41,220,255,.8) .65px,transparent .9px); background-size:8px 8px; mask-image:linear-gradient(90deg,black,transparent 58%); pointer-events:none; }
