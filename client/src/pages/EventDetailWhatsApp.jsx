...
const ticketFlowCss = `
  .flow-page { --f-ink:#050b14; --f-panel:#0b1725; --f-panel2:#10243a; --f-blue:#29dcff; --f-line:#255473; min-height:100vh; padding-top:86px; background:var(--f-ink); color:#f2fbff; font-family:'DM Sans',sans-serif; }.flow-page *{box-sizing:border-box}.flow-loading{min-height:70vh;display:grid;place-content:center;gap:14px;background:var(--f-ink);color:#f2fbff;text-align:center}.flow-loading span{width:34px;height:34px;margin:auto;border:3px solid rgba(41,220,255,.2);border-top-color:var(--f-blue);border-radius:50%;animation:flowspin .8s linear infinite}.flow-loading button{border:1px solid var(--f-blue);padding:10px 15px;background:transparent;color:#fff;cursor:pointer}@keyframes flowspin{to{transform:rotate(360deg)}}
