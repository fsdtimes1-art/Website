...
const ticketFlowCss = `
  .flow-page { --f-ink:#050b14; --f-panel:#0b1725; --f-panel2:#10243a; --f-blue:#29dcff; --f-line:#255473; min-height:100vh; background:var(--f-ink); color:#f2fbff; font-family:'DM Sans',sans-serif; }.flow-page *{box-sizing:border-box}.flow-loading{min-height:70vh;display:grid;place-content:center;gap:14px;background:var(--f-ink);color:#f2fbff;text-align:center}.flow-loading span{width:34px;height:34px;margin:auto;border:3px solid rgba(41,220,255,.2);border-top-color:var(--f-blue);border-radius:50%;animation:flowspin .8s linear infinite}.flow-loading button{border:1px solid var(--f-blue);padding:10px 15px;background:transparent;color:#fff;cursor:pointer}@keyframes flowspin{to{transform:rotate(360deg)}}
  .flow-hero{position:relative;height:clamp(240px,38vw,500px);overflow:hidden;background:#06111e}.flow-hero>img,.flow-hero>div{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.flow-hero-shade{background:linear-gradient(0deg,rgba(9,7,13,.95),rgba(9,7,13,.05) 70%)}.flow-hero button{position:absolute;z-index:2;top:24px;left:24px;border:1px solid rgba(255,255,255,.2);border-radius:999px;padding:9px 13px;background:rgba(9,7,13,.72);color:#fff;font:600 12px 'DM Sans',sans-serif;cursor:pointer}.flow-hero>span{position:absolute;z-index:2;left:30px;bottom:24px;border-radius:999px;padding:5px 9px;background:var(--f-blue);color:#250713;font-size:9px;font-weight:800;letter-spacing:.12em}
  .flow-wrap{display:grid;grid-template-columns:minmax(0,1fr) 380px;gap:42px;padding-top:38px;padding-bottom:80px}.flow-event-title h1{margin:0;font-family:'Bebas Neue',Impact,sans-serif;font-size:clamp(2.6rem,5vw,4.5rem);font-weight:400;letter-spacing:.02em;line-height:.95}.flow-event-title>div{display:flex;flex-wrap:wrap;gap:8px 18px;margin-top:16px;color:#a9c9da;font-size:13px;font-weight:600}.flow-tabs{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin:28px 0 20px;border-radius:999px;padding:6px;background:#080609}.flow-tabs a{border-radius:999px;padding:10px;color:#a9c9da;font-size:12px;font-weight:700;text-align:center;text-decoration:none}.flow-tabs a:first-child{background:var(--f-blue);color:#230711}.flow-info{display:grid;grid-template-columns:repeat(2,1fr);gap:8px}.flow-info>div{min-height:84px;border:1px solid var(--f-line);border-radius:12px;padding:14px;background:var(--f-panel)}.flow-info p,.flow-section header p{margin:0;color:#a9f4ff;font-size:9px;font-weight:800;letter-spacing:.13em;text-transform:uppercase}.flow-info strong{display:block;margin-top:7px;color:#fff;font-size:13px;line-height:1.35}.flow-section{margin-top:42px}.flow-section header{display:flex;align-items:end;justify-content:space-between;gap:15px;margin-bottom:14px}.flow-section h2{margin:5px 0 0;font-family:'Bebas Neue',Impact,sans-serif;font-size:2rem;font-weight:400;letter-spacing:.02em}.flow-about>p{max-width:700px;color:#a8c4d6;font-size:14px;line-height:1.75}
  .flow-ticket-list{display:grid;gap:9px}.flow-ticket-row{display:grid;grid-template-columns:22px 1fr auto;align-items:center;gap:12px;width:100%;border:1px solid var(--f-line);border-radius:12px;padding:15px;background:var(--f-panel);color:#fff;text-align:left;cursor:pointer;transition:border-color .18s,background .18s,transform .18s}.flow-ticket-row:hover,.flow-ticket-row.is-selected{border-color:var(--f-blue);background:linear-gradient(90deg,rgba(41,220,255,.13),var(--f-panel))}.flow-ticket-row.is-sold{opacity:.52;cursor:not-allowed}.flow-ticket-radio{display:grid;width:20px;height:20px;place-items:center;border:2px solid #6590ac;border-radius:50%}.flow-ticket-row.is-selected .flow-ticket-radio{border-color:var(--f-blue)}.flow-ticket-row.is-selected .flow-ticket-radio i{width:9px;height:9px;border-radius:50%;background:var(--f-blue)}.flow-ticket-copy strong,.flow-ticket-price{display:block;font-size:14px}.flow-ticket-copy small,.flow-ticket-price small{display:block;margin-top:4px;color:#8faec2;font-size:11px}.flow-ticket-price{color:#a9f4ff;font-weight:800;text-align:right}.flow-quantity{display:flex;align-items:center;justify-content:space-between;border:1px dashed #385d78;border-radius:12px;padding:14px;background:#07111e}.flow-quantity p{margin:0;color:#fff;font-size:13px;font-weight:700}.flow-quantity span{display:block;margin-top:3px;color:#8faec2;font-size:11px}.flow-stepper{display:flex;align-items:center}.flow-stepper button,.flow-stepper b{display:grid;width:34px;height:34px;place-items:center;border:1px solid #385d78;background:#11243a;color:#fff;font-size:18px}.flow-stepper button{cursor:pointer}.flow-stepper button:disabled{opacity:.35;cursor:not-allowed}.flow-stepper b{border-inline:0;color:#a9f4ff;font-size:14px}
